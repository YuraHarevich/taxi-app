...
import static com.Harevich.rideservice.util.constants.TariffMultiplyConstants.END_OF_HOUR_MULTIPLY_CONSTANT;
import static com.Harevich.rideservice.util.constants.TariffMultiplyConstants.EVENING_MULTIPLY_CONSTANT;
import static com.Harevich.rideservice.util.constants.TariffMultiplyConstants.MORNING_MULTIPLY_CONSTANT;
import static com.Harevich.rideservice.util.constants.TimeTariffConstantValues.EVENING_PEAK_END;
import static com.Harevich.rideservice.util.constants.TimeTariffConstantValues.EVENING_PEAK_START;
import static com.Harevich.rideservice.util.constants.TimeTariffConstantValues.MINUTES_IN_HOUR_WITHOUT_INCREASED_TARIFF;
import static com.Harevich.rideservice.util.constants.TimeTariffConstantValues.MORNING_PEAK_END;
import static com.Harevich.rideservice.util.constants.TimeTariffConstantValues.MORNING_PEAK_START;
import static com.Harevich.rideservice.util.constants.TimeTariffConstantValues.TARIFF_PER_KM;
